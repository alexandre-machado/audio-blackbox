 ...
 *
 * Lifted from the closed PR #124 (`feat/121-retire-window-selector`), adapted to current `main`
 * (issue #129).
 *
 ...
 * a regression that silently swaps in [RecorderService.handleSave]'s configured capacity instead
 * of the actually-buffered amount -- exactly the "N min promised, less delivered" bug class this
 * issue closes -- fails this test.
 */
